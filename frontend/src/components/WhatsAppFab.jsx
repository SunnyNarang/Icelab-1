...
export const WhatsAppFab = () => {
  ...
  return (
    ...
    >
      ...
      <span className="relative inline-flex items-center justify-center w-14 h-14 lg:w-16 lg:h-16 bg-[#25D366] hover:bg-[#1FB856] text-white shadow-[0_8px_30px_rgba(37,211,102,0.35)] transition-colors">
        <MessageCircle size={22} strokeWidth={1.75} fill="white" />
      </span>
    </a>
  );
};
